...
public class EmployeeShiftController {
    ...
    public ResponseEntity<List<EmployeeShift>> updateEmployeeDetails(
            @PathVariable String employeeName,
            @RequestBody EmployeeShift updatedEmployeeShift) {
        List<EmployeeShift> updatedShifts = employeeShiftService.updateEmployeeDetails(employeeName, updatedEmployeeShift);
    ...
    public ResponseEntity<Void> deleteEmployeeData(@PathVariable String employeeName) {
        employeeShiftService.deleteEmployeeData(employeeName);
